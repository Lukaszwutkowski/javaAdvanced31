...
public class PriceTest {
    ...
    void shouldProperlySubtractPrice() {
        ...
        double price1 = 0.01; // Niepoprawne uzycie dla pieniedzy
        double price2 = 0.03;

        System.out.println(price1-price2);

        BigDecimal price3 = new BigDecimal(0.01); // Niepoprawne uzycie dla pieniedzy
        BigDecimal price4 = new BigDecimal(0.03);

        System.out.println(price3.subtract(price4));

        BigDecimal price5 = BigDecimal.valueOf(0.01); // // Poprawne uzycie dla pieniedzy
